      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
        <Card className="border-0 shadow-md">
          ...
          <CardContent className="space-y-3">
            ...
            <a
              href="/admin/review"
              className="flex items-center justify-between p-3 rounded-lg bg-slate-50 hover:bg-amber-50 transition-colors group"
            >
            ...
            <a
              href="/admin/seat-map"
              className="flex items-center justify-between p-3 rounded-lg bg-slate-50 hover:bg-purple-50 transition-colors group"
            >
              <span className="text-slate-700 group-hover:text-purple-700 font-medium">
                View Seat Map
              </span>
